package mia.strategy.service.algorithm;
...
public abstract class BaseAlgorithm implements IDrawAlgorithm {
    ...
    protected Map<Long, List<AwardRateInfoVO>> AwardRateInfoVOMap = new ConcurrentHashMap<>();
    ...
    public void initRateTuple(Long strategyId, List<AwardRateInfoVO> AwardRateInfoVOList) {
        ...
        AwardRateInfoVOMap.put(strategyId, AwardRateInfoVOList);
    ...
    public boolean isExist(Long strategyId) {
        return AwardRateInfoVOMap.containsKey(strategyId);
    }
